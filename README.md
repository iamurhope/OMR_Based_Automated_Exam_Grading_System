...
| Paper Detection | OpenCV Canny, CLAHE | Хуудас илрүүлэх 9 шатлалт стратеги |
| Perspective | getPerspectiveTransform | 4 өнцгийг олж зургийг тэгшлэх |
| Bubble Detection | Adaptive Threshold, Contours | Дугуй хэлбэр ба доторх тодролыг шинжлэх |
| Grid Organization | DBSCAN-inspired logic | Хариултуудыг мөр, баганаар эрэмбэлэх |
| Variant Detection | ROI extraction | Хувилбарын хэсгийг (ROI) тусгаарлаж таних |
| Grading Logic | NumPy & Python Dicts | Түлхүүр хариулттай харьцуулж оноо бодох |
